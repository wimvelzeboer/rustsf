...
impl MetadataDeployer {
	...
	///
	fn add_file_to_zip(&mut self, folder: &str, file_name: &str, content: &[u8]) -> Result<(), SZipError> {
	...
	///
	fn add_package(&mut self, name: &str, content: HashMap<String, Vec<String>>) -> Result<()> {
